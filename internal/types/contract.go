...
// Contract represents an Photon smart contract at the blockchain.
...
func NewSfcContract(addr *common.Address, ver uint64, block *Block, trx *Transaction) *Contract {
	...
	con.SupportContact = "https://techpay.io"
	con.License = "MIT"
	con.Compiler = "Solidity"
	con.SourceCode = "https://github.com/TechPay-io/photon-sfc"
...
func NewStiContract(addr *common.Address, block *Block, trx *Transaction) *Contract {
	...
	con.Version = "1.4.0"
	con.SupportContact = "https://github.com/block42-blockchain-company/techpay-staker-info"
	con.License = "MIT"
	con.Compiler = "Solidity"
	con.SourceCode = "https://github.com/block42-blockchain-company/techpay-staker-info"
