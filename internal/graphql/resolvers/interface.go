...
type ApiResolver interface {
	...
	// LastStakerId resolves the last staker id in Photon blockchain.
	LastStakerId() (hexutil.Uint64, error)

	// StakersNum resolves the number of stakers in Photon blockchain.
	...
	// Price resolves price details of the Photon blockchain token for the given target symbols.
