...
// defiWTPCSymbol is the symbol used for wrapped TPC tokens.
const defiWTPCSymbol = "WTPC"
...
// DefiNativeToken resolves the native TPC wrapper token.
...
// CanWrapTPC signals if the token can be used to wrap native TPC
// to get some amount of it.
func (dt *DefiToken) CanWrapTPC() bool {
	return dt.Symbol == defiWTPCSymbol
}
