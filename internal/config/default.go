...
const (
	...
	defApplicationName = "TechPay GraphQL API Server (custom)"
	...
	// defSiriusUrl holds default Sirius connection string
	defSiriusUrl = "~/.photon/data/photon.ipc"
...
var defERC20Logo = map[common.Address]string{
	common.HexToAddress(EmptyAddress): "https://repository.techpay.io/logos/erc20.svg",
}
...
func applyDefaults(cfg *viper.Viper) {
	...
	cfg.SetDefault(keySiriusUrl, defSiriusUrl)
