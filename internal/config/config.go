...
// Config defines configuration options structure for TechPay API server.
type Config struct {
	...
	// Sirius represents the node structure
	Sirius Sirius `mapstructure:"node"`
...
// Sirius represents the Sirius node access configuration
type Sirius struct {
