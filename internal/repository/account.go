...
// getAccount builds the account representation after validating it against Sirius node.
...
// AccountTransactions returns slice of AccountTransaction structure for a given account at Photon blockchain.
