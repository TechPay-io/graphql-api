...
// GetTechPayMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getTechPayMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCaller) GetTechPayMint(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DefiFMintAddressProvider.contract.Call(opts, &out, "getTechPayMint")
...
//
// Solidity: function getTechPayMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) GetTechPayMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetTechPayMint(&_DefiFMintAddressProvider.CallOpts)
}

// GetTechPayMint is a free data retrieval call binding the contract method 0x44969711.
//
// Solidity: function getTechPayMint() view returns(address)
func (_DefiFMintAddressProvider *DefiFMintAddressProviderCallerSession) GetTechPayMint() (common.Address, error) {
	return _DefiFMintAddressProvider.Contract.GetTechPayMint(&_DefiFMintAddressProvider.CallOpts)
}
...
// SetTechPayMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setTechPayMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactor) SetTechPayMint(opts *bind.TransactOpts, _addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.contract.Transact(opts, "setTechPayMint", _addr)
}

// SetTechPayMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setTechPayMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderSession) SetTechPayMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetTechPayMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}

// SetTechPayMint is a paid mutator transaction binding the contract method 0xfcc3c074.
//
// Solidity: function setTechPayMint(address _addr) returns()
func (_DefiFMintAddressProvider *DefiFMintAddressProviderTransactorSession) SetTechPayMint(_addr common.Address) (*types.Transaction, error) {
	return _DefiFMintAddressProvider.Contract.SetTechPayMint(&_DefiFMintAddressProvider.TransactOpts, _addr)
}
