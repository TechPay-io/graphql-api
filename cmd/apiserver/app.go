...
import (
	...
	"os/signal"
	"syscall"
	"techpay-api-graphql/cmd/apiserver/build"
	"techpay-api-graphql/internal/config"
	"techpay-api-graphql/internal/graphql/resolvers"
	"techpay-api-graphql/internal/handlers"
	"techpay-api-graphql/internal/logger"
	"techpay-api-graphql/internal/repository"
	"techpay-api-graphql/internal/svc"
	"time"
)
...
func (app *apiServer) run() {
	...
	app.log.Infof("welcome to TechPay GraphQL API server")
